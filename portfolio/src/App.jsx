      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex space-x-6 mt-4 md:mt-0">
          ...
          >
            {/* Facebook Icon */}
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
              <path strokeLinecap="round" strokeLinejoin="round" d="M18 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2h8V14h-3v-4h3V8c0-3.31 2.69-5 5-5 1.38 0 2.67.5 3.6 1.34V7h-2c-1.1 0-2 .9-2 2v3h4l-1 4h-3v8h5c1.1 0 1.99-.9 1.99-2L22 4c0-1.1-.89-2-1.99-2z" />
            </svg>
          </a>
          <a
